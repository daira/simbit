...
var difficultyAlgorithms = ['Bitcoin', 'Bitcoin every block', 'DigiShield v3', 'DigiShield v3 without median', 'Dark Gravity Wave v3', 'Ethereum', 'MIDAS', 'MIDAS w/o CalSync'];
...
// Default
setDifficultyAlgorithm('Bitcoin');
...
if (net.visualizer) {
	net.check(1000 * 1000, function() {
		...
		checkpoint = head.h;
		console.log("Data: " + data.length + ", checkpoint: " + checkpoint);

		net.visualizer.drawGraph(data);
	/*
